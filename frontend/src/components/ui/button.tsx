...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary-600 text-white hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-500/30",
        destructive: "bg-red-500 text-white hover:bg-red-600 hover:shadow-lg hover:shadow-red-500/30",
        outline: "border border-input bg-background hover:bg-neutral-50 hover:text-primary-600",
        secondary: "bg-secondary-600 text-white hover:bg-secondary-700 hover:shadow-lg hover:shadow-secondary-500/30",
        ghost: "hover:bg-neutral-100 hover:text-primary-600",
        link: "text-primary-600 underline-offset-4 hover:underline",
        soft: "bg-primary-50 text-primary-700 hover:bg-primary-100 hover:shadow-md",
